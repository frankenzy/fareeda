...
@section('content')
    <script>
        ...
        function addToCart(id, nom, description, quantity, event) {
            ...
            currentBasket.push(newCartItem);
            localStorage.setItem('basket', JSON.stringify(currentBasket));
            order++;
            localStorage.setItem('order', order);
            console.log('Nouvel article ajouté au panier:', newCartItem);
            console.log('Panier mis à jour:', currentBasket);
            reload();
        }
                                                            ...
                                                            <div class="flex col-span-2 justify-between">
                                                                ...
                                                                <div class='flex items-center'>
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        @click="order++; addToCart('{{ addslashes($item->id) }}','{{ addslashes($item->nom) }}','{{ addslashes($item->description) }}', quantity,$event)">
                                                                        Ajouter au panier
                                                                    </button>
                                                                </div>
                                                            </div>
