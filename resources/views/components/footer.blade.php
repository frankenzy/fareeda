<div class="block sticky grid-rows-1 items-center w-full">
    <div {{ $attributes->merge(['class' => 'items-center py-6 mt-0 text-center text-sm text-black dark:text-white/70']) }}>
                ...
                <div class="flex justify-between grids-cols-2">
                    <div class="flex grid">
                        <div class="grid grid-cols-1 gap-1">
                            ...
                            <div>
                                ...
                                <p><a href="mailto:info@fareeda.pro" class="text-2xl text-orange-500 text-start"><i
                                            class="icofont-email"></i> &nbsp;info@fareeda.pro</a></p>
                                <ul class="flex text-2xl">
                                    ...
                                    <li class="mx-2 my-2"><a
                                            href="https://api.whatsapp.com/send?phone=+2250777146839&amp;text=https%3A%2F%2Fwww.fareeda.pro%2F"
                                            class="text-start"><i class="fa fa-whatsapp whatsapp"></i></a></li>

                                    <li class="mx-2 my-2"><a
                                            href="http:// https://www.linkedin.com/in/fareeda-technologie-bb3a0b254/"
                                            class="text-start"><i class="fa fa-linkedin linkedin"></i></a></li>
                    ...
                    <div class="flex grid">
                        ...
                        <div class="grid grid-cols-1 gap-1 text-xl">
                            ...
                            <ul>
                                <li>
                                    <i class="text-orange-500 fa fa-angle-right"></i>
    ...
    <div class="flex bottom-0 justify-center items-center py-4 bg-gray-200">
